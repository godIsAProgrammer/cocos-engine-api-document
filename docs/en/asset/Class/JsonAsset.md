...
##### Defined in &nbsp;   [cocos/core/assets/json-asset.ts:48](https://github.com/cocos-creator/engine/blob/c7bf6b8a9/cocos/core/assets/json-asset.ts#L48)&nbsp;
...
• **new JsonAsset**(`args: ConstructorParameters`)
