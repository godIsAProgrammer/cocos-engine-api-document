...
• **new BufferAsset**(`args: ConstructorParameters`)
...
##### Defined in &nbsp;   [cocos/core/assets/buffer-asset.ts:52](https://github.com/cocos-creator/engine/blob/c7bf6b8a9/cocos/core/assets/buffer-asset.ts#L52)&nbsp;
___
### createNode
...
##### Defined in &nbsp;   [cocos/core/assets/buffer-asset.ts:56](https://github.com/cocos-creator/engine/blob/c7bf6b8a9/cocos/core/assets/buffer-asset.ts#L56)&nbsp;
___
<!---->
