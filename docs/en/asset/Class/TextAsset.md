...
##### Defined in &nbsp;   [cocos/core/assets/text-asset.ts:48](https://github.com/cocos-creator/engine/blob/c7bf6b8a9/cocos/core/assets/text-asset.ts#L48)&nbsp;
...
• **new TextAsset**(`args: ConstructorParameters`)
...
##### Defined in &nbsp;   [cocos/core/assets/text-asset.ts:50](https://github.com/cocos-creator/engine/blob/c7bf6b8a9/cocos/core/assets/text-asset.ts#L50)&nbsp;
___
### validate
<div style="margin-left: 10px;">
