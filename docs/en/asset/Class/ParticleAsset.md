...
##### Defined in &nbsp;   [cocos/particle-2d/particle-asset.ts:46](https://github.com/cocos-creator/engine/blob/c7bf6b8a9/cocos/particle-2d/particle-asset.ts#L46)&nbsp;
...
• **new ParticleAsset**(`args: ConstructorParameters`)
